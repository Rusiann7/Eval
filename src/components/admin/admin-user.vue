<template>
    ...
    <ul>
      <li>
        <a href="#" @click.prevent="$router.push('/homepage')">Evaluation Home</a>
      </li>
      <li class="hideMobile">
        <a href="#" @click.prevent="$router.push('/homepage')">Home Page</a>
      </li>
      <li class="hideMobile">
        <a href="#" @click.prevent="$router.push('/adminUser')">Evaluation</a>
      </li>
